        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            ScrollView {
                LazyVStack(alignment: .leading, spacing: 6) {
                    ...
                    Text("Option temporarily selects the eyedropper in painting tools. Shift constrains shapes/movement or adds to a selection; Option subtracts from selections or draws from center. Command-drag moves selected pixels; Command-Option-drag copies them. Option-drag duplicates layers/folders/effects; Option-click at a layer boundary toggles clipping. Command-click a thumbnail loads its selection. Control bypasses snapping. Right-drag adjusts brush size. With the Brush or Eraser, Shift and a number sets flow the way a number alone sets opacity. Modifier-and-mouse gestures are fixed.")
                }.padding(.trailing, 8)
            }.frame(height: 465)
